...
add_psi_counts_per_repl <- function(event, rmats_dir, suffix) {
  ...
  for (li in 1:nrow(t) ){
    ...
    t$IncLevel1_r4[li]  <- as.numeric(unlist(strsplit(t$IncLevel1[li],","))[4])
    t$IncLevel1_r5[li]  <- as.numeric(unlist(strsplit(t$IncLevel1[li],","))[5])
    t$IncLevel1_r6[li]  <- as.numeric(unlist(strsplit(t$IncLevel1[li],","))[6])
