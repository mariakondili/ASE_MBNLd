...
// Count genes for DESeq2-analysis
// ~~~
...
params.samplelist  = "/mbnl_dct/mouse_analysis/NXF_files/fastq_samplesheet_mouse.tsv"
params.data_dir  = "/mbnl_dct/mouse_seq/fastq/"
params.cutadapt_dir = "/mbnl_dct/mouse_seq/Nextflow_STAR/cut_adapted"
params.outDir= "/mbnl_dct/mouse_seq/Nextflow_STAR/Aligned"
params.countsDir= "/mbnl_dct/mouse_seq/Nextflow_STAR/HTSeq_counts"
...
// mkdir -p /mbnl_dct/mouse_seq/cut_adapted/  \
// cutadapt --cores 8 -B AGATCGGAAGAG --minimum-length 75 --report  minimal  \
// --o /mbnl_dct/mouse_seq/cut_adapted/1051_R1_cutadapt.fastq.gz \
// -p /mbnl_dct/mouse_seq/cut_adapted/1051_R2_cutadapt.fastq.gz \
// -Z \
// /mbnl_dct/mouse_seq/fastq/1051_R1.fastq \
// /mbnl_dct/mouse_seq/fastq/1051_R2.fastq
...
process STAR_Alignment {
      ...
      output:
      tuple path("${bn}/${bn}_Aligned.sortedByCoord.out.bam"),val(bn) into alignChannel
...
// -- STAR params used in ENCODE project ----
